    ...
    <form action="" method="POST">
        ...
        <div class="container text-center px-5 my-5 ">
            ...
            <div class="form-floating my-3">
                <a href="Alogin.php" ><button type="button" class="btn btn-outline-primary me-2">Iniciar como administrador</button></a>
                <a href="Clogin.php" ><button type="button" class="btn btn-outline-primary me-2">Iniciar como cliente</button></a>
            </div>
        </div>
    </form> 
