<?php 
    include("db\db.php");
    include("session\signin_customer.php");
    ...
    <form action="" method="POST">
        ...
        <form>
            ...
            <div class="row g-2">
                <div class="col-md">
                    <div class="form-floating my-3">
                        <input type="text" class="form-control" id="inputEmail" name ="colonia" placeholder="Colonia" required="" autofocus>
                        <label for="inputEmail">Colonia</label>
                    </div>
                </div>
                <div class="col-md">
                    <div class="form-floating my-3">
                    <input type="text" class="form-control" id="inputEmail" name ="calle" placeholder="Calle" required="" autofocus>
                        <label for="inputEmail">Calle</label>
                    </div>
                </div>
                <div class="col-md">
                    <div class="form-floating my-3">
                    <input type="text" class="form-control" id="inputEmail" name ="numero" placeholder="numero" required="" autofocus>
            ...
            <div class="row g-2">
                ...
                <div class="col-md">
                    <div class="form-floating my-3">
                        <input type="text" class="form-control" id="inputEmail" name ="Telefono" placeholder="Telefono" required="" autofocus max=10 min=8>
            ...
            <div class="d-grid my-3 rounded-3">
                <button type="submit" class ="btn btn-outline-primary my-2" name ="guardarCustomer" value ="Crear Cuenta"> Crear cuenta </buttton>
